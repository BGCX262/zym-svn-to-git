 ...
 *
 */
class Zend_Image_Action_DrawLine extends Zend_Image_Action_ActionAbstract {
    /*
    ...
    public function setColor($color, $green = null, $blue = null){
        if (!$color instanceof Zend_Image_Color) {
            $color = new Zend_Image_Color($color, $green, $blue);
        }
