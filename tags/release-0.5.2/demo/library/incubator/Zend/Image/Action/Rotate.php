...
class Zend_Image_Action_Rotate extends Zend_Image_Action_ActionAbstract
{
     ...
     * @return Zend_Image_Action_Rotate Provides fluent interface
     */
    public function setBackgroundColor($color, $g = null, $b = null) {
        $this->_backgroundColor = new Zend_Image_Color($color, $g, $b);
