 ...
 *
 */
class Zend_Image_Action_Mirror extends Zend_Image_Action_ActionAbstract
{
    ...
    /**
     * @param string $axis
     * @return Zend_Image_Action_Flip Provides fluent interface
     */
    public function setAxis($axis){
        ...
        if(!$this->flop() && !$this->flip()) {
            ...
            throw new Zend_Image_Exception('Invalid axis specified');
        }
