...
/**
 * @see Zend_Filter_Encrypt_EncryptInterface
 */
require_once 'Zend/Filter/Encrypt/EncryptInterface.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Filter_Encrypt_Openssl implements Zend_Filter_Encrypt_EncryptInterface
{
    /**
