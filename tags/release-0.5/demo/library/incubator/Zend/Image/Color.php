...
class Zend_Image_Color {
    ...
    public function __construct($param1 = 0, $green = null, $blue = null) {
        if($this->_red !== null ||
           ...
           $this->_blue !== null)
        {
            throw new Zend_Image_Exception('Can only set color once.');
        }
     ...
     * @param int $g
     * @param int $bz
     * @return Zend_Image_Color Fluent interface
     */
    protected function _setRgb($r, $g, $b){
           ...
           !ctype_digit((string) $b))
        {
            ...
            throw new Zend_Image_Exception('When setting a color, both
